...
namespace NzbDrone.Core.Download.Clients.Nzbget
{
    public interface INzbgetProxy
    {
        ...
        string DownloadNzbByLink(string url, string category, int priority, bool addpaused, NzbgetSettings settings);
    ...
    public class NzbgetProxy : INzbgetProxy
    {
        ...
        public void RemoveItem(string id, NzbgetSettings settings)
        {
            ...
            {
                // Download wasn't grabbed by Fetcharr, so the id is the NzbId reported by nzbget.
