...
namespace NzbDrone.Core.Download.Clients.NzbVortex
{
    ...
    public class NzbVortexSettings : IProviderConfig
    {
        ...
        [FieldDefinition(4, Label = "Default Category", Type = FieldType.Textbox, HelpText = "Default fallback category if no mapped category exists for a release. Adding a category specific to Fetcharr avoids conflicts with unrelated downloads, but it's optional")]
